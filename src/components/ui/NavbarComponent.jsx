...
const NavbarComponent = () => {
  return (
    <nav className=" border-gray-200 dark:bg-gray-900 ">
      <div className="h-28 flex flex-wrap items-center  mx-auto w-full ">
        {/* Logo */}

        <a
          href="http://localhost:3000/"
          className="flex items-center space-x-3 rtl:space-x-reverse  w-[30%] px-16 "
        >
          <img
        ...
        {/* Menue */}
        <div className="flex  w-[70%] justify-end px-9">
          ...
          <div
            className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 px-20"
            id="navbar-search"
          >
            ...
            <ul className="flex flex-col  md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 text-white text-xl ">
              <li>
                <a
                  href="http://localhost:3000/"
